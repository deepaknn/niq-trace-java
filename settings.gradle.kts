...
include(
  ...
  ":dd-java-agent:instrumentation:niq-response-header:javax-servlet",
  ":dd-java-agent:instrumentation:niq-response-header:jakarta-servlet",
  ":dd-java-agent:instrumentation:niq-response-header:jetty",
  ":dd-java-agent:instrumentation:niq-response-header:grpc-server",
  ":dd-java-agent:instrumentation:niq-response-header:netty-4.1",
  ":dd-java-agent:instrumentation:niq-response-header:netty-4.0",
  ":dd-java-agent:instrumentation:niq-response-header:netty-3.8",
  ":dd-java-agent:instrumentation:niq-response-header:spring-webflux-5.0",
  ":dd-java-agent:instrumentation:niq-response-header:spring-webflux-6.0",
  ":dd-java-agent:instrumentation:niq-response-header:undertow",
  ":dd-java-agent:instrumentation:niq-response-header:vertx-3.4",
  ":dd-java-agent:instrumentation:niq-response-header:vertx-4.0",
  ":dd-java-agent:instrumentation:niq-response-header:vertx-5.0",
  ":dd-java-agent:instrumentation:niq-response-header:armeria",
  ":dd-java-agent:instrumentation:niq-response-header:grizzly",
  ":dd-java-agent:instrumentation:niq-response-header:play",
  ":dd-java-agent:instrumentation:niq-response-header:niq-tests",
